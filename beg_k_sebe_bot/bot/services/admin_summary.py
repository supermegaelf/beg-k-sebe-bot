...
_COLUMNS = [
    ...
    ("Ежедневно: что помогло тебе сегодня совершить действие?", 45),          # 17 день
    ("Ежедневно: что было сложнее всего?", 40),                               # 18 день
    ("Ежедневно: что сегодня сдвинулось в сторону своей цели?", 45),          # 19 день
    ("Рефлексия: какой результат или внутренний сдвиг произошёл за эту неделю?", 45),  # 20 неделя
    ("Рефлексия: что помогало тебе сохранять движение на этой неделе?", 40),  # 21 неделя
    ("Рефлексия: что на этой неделе оказалось самым сложным?", 40),           # 22 неделя
    ("Рефлексия: насколько ты приблизился(лась) к своей цели за эту неделю?", 40),  # 23 неделя
    ("Рефлексия: чем из этого ты хотел(а) бы поделиться с сообществом?", 40),  # 24 неделя
]
